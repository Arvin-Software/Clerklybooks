...
//   include 'newsagencyapi.php';
  include 'newsagencyapi.php';
            // inventor::insertGIN($_POST['ginno'], $_POST['dt'], $_POST['grsno'], $_POST['dept']);
                newsagencyapi::insertEntrySo($_POST['dt'], $_POST['dept'], '', '', '', '');
            ...
            for($i = 0; $i <= $loopval; $i++){
                if(isset($_POST['prod' . $i])){
                    ...
                    newsagencyapi::insertItemsSo($_POST['prod' . $i], '', $_POST['dt' . $i], '', '', '', '', $val);
...
//   include 'newsagencyapi.php';
  include '../../classes/inventor.php';
    ...
    <div class="container-fluid bor-ten" style="padding-top: 2%; background-color: #FFFFFF;">
        <h4><i class="fas fa-file-invoice"></i>&nbsp;New entry</h4>
        <a href="totitems.php" class="btn btn-success bor-ten"><i class="far fa-arrow-alt-circle-left"></i>&nbsp;&nbsp;Back</a>
        ...
        <form action="items.php" method="post" class="border bg-white bor-ten " style="padding: 2% 2% 2% 2%;">
