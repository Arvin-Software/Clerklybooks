$(document).ready(function(){
    var a = 1;
            ...
            function(data, status){
                ...
                $('#here_table').append('<tr><td><select id="prod' + a +'" name="prod' + a + '" class="custom-select prodx"></select></td><td><input class="form-control  rte accx" required="" type="text" name="dt' + a + '" id="dt' + a + '"></td><td><button type="button" id="deletebut" name="deletebut" class="btn btn-danger btndeleterowadded">X</button></td></tr>');
                for(i=1; i<=myObj[0]; i++){
