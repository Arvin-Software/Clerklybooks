...
<body class="" style="background-color: #FFFFFF;" oncontextmenu="return false;">
    ...
    <div class="row" style=" height: 100vh;">
                ...
                <button class="navbar-toggler  bg-white" type="button" data-toggle="collapse" data-target="#navbarWEX" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                 ...
                 <div class="navbar-collapse collapse" id="navbarWEX" style="border-radius: 20px 20px 20px 20px;">
                    <div class="nav flex-md-column flex-column" style="overflow: auto;  width: 100%;">
                        ...
                        <a href="javascript:void(0);" class="btn-nav nav-item nav-link btn text-left bor-none btn-col"  id="dash" name="dash">&nbsp;&nbsp;&nbsp;<i class="fas fa-chart-line"></i>&nbsp;&nbsp;Dashboard</a>
                            <h5 style="margin-top: 5%; margin-left: 3%;">Materials</h5>
                            <a href="javascript:void(0);" style="" class="btn-nav nav-item nav-link btn text-left bor-none"  id="users" name="users">&nbsp;&nbsp;&nbsp;<i class="fas fa-boxes"></i>&nbsp;&nbsp;Purchase order</a>
                            <a class="btn-nav nav-item nav-link btn bor-none text-left" id="comp" name="comp" href="javascript:void(0);">&nbsp;&nbsp;&nbsp;<i class="fas fa-dolly-flatbed"></i>&nbsp;&nbsp;Inventory</a>
                            <h5 style=" margin-left: 3%;">Entry</h5>
                            <a href="javascript:void(0);" class="btn-nav nav-item nav-link btn text-left bor-none"  id="invoi" name="invoi">&nbsp;&nbsp;&nbsp;<i class="fas fa-file-invoice"></i>&nbsp;&nbsp;Invoice</a>
                            <a href="javascript:void(0);" class="btn-nav nav-item nav-link btn text-left bor-none" id="modul" name="modul">&nbsp;&nbsp;&nbsp;<i class="fas fa-truck-moving"></i>&nbsp;&nbsp;EWay Bill / DC</a>
                            <h5 style=" margin-left: 3%;">Books</h5>
                            <a href="javascript:void(0);" class="btn-nav nav-item nav-link btn text-left bor-none"  id="grn" name="grn">&nbsp;&nbsp;&nbsp;<i class="fas fa-book"></i>&nbsp;&nbsp;Goods received note</a>
                            ...
                            <!-- <h5>Reports</h5> -->
                            <a href="javascript:void(0);" class="btn-nav nav-item nav-link btn text-left bor-none"  id="srb" name="srb">&nbsp;&nbsp;&nbsp;<i class="fas fa-pallet"></i>&nbsp;&nbsp;Stock register book</a>
                            <a href="javascript:void(0);"  class="btn-nav nav-item nav-link btn text-left bor-none"  id="gin" name="gin">&nbsp;&nbsp;&nbsp;<i class="fas fa-truck-loading"></i>&nbsp;&nbsp;Goods Issue Note</a>
                            
                            
                        <!-- </div> -->
                        <!-- <div class="border bor-none" style=" padding: 20px 30px 30px 20px; background-color:javascript:void(0);F2F2F2; margin-top: 5%;"> -->
                            <h5 style=" margin-left: 3%;">Others</h5>
                            <a href="javascript:void(0);"  class="btn-nav nav-item nav-link btn text-left bor-none"  id="supp" name="supp">&nbsp;&nbsp;&nbsp;<i class="fas fa-user-friends"></i>&nbsp;&nbsp;Supplier</a>
        ...
        <div class="col-lg-10 bg-light" style="padding-left: 10px; padding-right: 10px;">
            <div class="container-fluid border bg-white d-none d-lg-block" style="margin-bottom: 1%;  margin-top: 1%; padding-bottom: 1%; width: 98%; padding-left: 2%; padding-right: 2%;">
                <label for="dtandtm" class="fade-in" id="navg" name="navg" style="padding-top: 15px; padding-bottom: 0px; padding-left: 2px; padding-right: 15px; background-color: #FFFFFF;"><a href="switcher.php" class="navigator">Clerkly Books</a> / <a href="#" class="navigator">Inventor</a></label>
                ...
                <img src="<?php echo $logo; ?>" class="fade-in img-info rounded-circle float-right border dropdown-toggle" data-toggle="dropdown"  style="margin-top: 8px; width: 42px; height: 42px;"><label for="dtandtm" class="float-right fade-in" style="padding-top: 15px; padding-bottom: 5px; padding-left: 15px; padding-right: 15px;  background-color: #FFFFFF;" id="dt" name="dt">Time : 00:00:00</label>
...
<script src="inventordash.js"></script>
<script>     
