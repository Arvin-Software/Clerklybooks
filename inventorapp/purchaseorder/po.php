...
<body class="bg-light" oncontextmenu="return false;">
    <div class="container-fluid bor-none border" style=" margin: 1% 1% 1% 1%; padding: 0% 2% 1% 2%; width: 98vw; background-color: #FFFFFF;">
        <!-- <h4><i class="fas fa-boxes"></i>&nbsp;Purchase Order</h4> -->
        ...
        <table class="table table-bordered">
            ...
            <?php
                $ret = khatral::khquery('SELECT * FROM entrypo WHERE inst=:inst', array(':inst'=>$_SESSION['instnm']));
                $count = 0;
                foreach($ret as $p){
                    $count = $count + 1;
                    $dt = $p['dt'];
