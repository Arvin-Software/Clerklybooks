...
<body class="bg-light" oncontextmenu="return false;">
    <div class="container-fluid bor-none border" style="width: 98vw; padding: 2% 2% 1% 2%; margin-top: 1%; margin-bottom: 5%; background-color: #FFFFFF;">
        <!-- <h4><i class="fas fa-truck-moving"></i>&nbsp;EWay Bill/ DC entry</h4> -->
        ...
        <table class="table table-bordered table-striped">
            ...
            <?php
                ...
                foreach($ret as $p){
                    ...
                    <td class="">' . $p['dcno'] . '</td>
                    <td class=""><a href="addview.php?id=' . $p['dc_id'] . '" style="" class="btn btn-outline-primary bor-none"><i class="fas fa-plus"></i>&nbsp;/&nbsp;<i class="far fa-eye"></i></a> 
                    </tr>';
                }
            ?>        
        </table>
