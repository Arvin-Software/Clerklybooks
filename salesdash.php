...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-2 bg-primary text-white" style=" margin-top: 1%; border-radius: 0px 10px 10px 0px;">
                 ...
                 <div class="navbar-collapse collapse bg-primary" id="navbarWEX" style="border-radius: 20px 20px 20px 20px;">
                    <div class="nav flex-md-column flex-column bg-primary" style="overflow: auto;  width: 100%;">
                        ...
                        <!-- <div class="border bor-ten" style=" padding-left: 30px; padding-right: 30px; padding-top: 20px; background-color:#F2F2F2; height: 60vh;"> -->
                            <h5>Materials</h5>
                            <a href="salesapp/salesorder/po.php" target="tar" class="nav-item nav-link btn text-left bor-ten text-white"  id="users" name="users"><i class="fas fa-boxes"></i>&nbsp;&nbsp;Sales order</a>
                            <a class="nav-item nav-link btn bor-ten text-left text-white" target="tar" id="comp" name="comp" href="salesapp/entry/mtrl.php"><i class="fas fa-dolly-flatbed"></i>&nbsp;&nbsp;Sales Inventory</a>
                            <!-- <h5>Entry</h5> -->
                            ...
                            <h5>Books</h5>
                            <a href="salesapp/grn/entrydash.php" class="nav-item nav-link btn text-left bor-ten text-white"  id="users" name="users"><i class="fas fa-book"></i>&nbsp;&nbsp;Goods received note</a>
                            ...
                            <!-- <h5>Reports</h5> -->
                            <a href="salesapp/srb/srb.php" target="tar" class="nav-item nav-link btn text-left bor-ten text-white"  id="srb" name="srb"><i class="fas fa-pallet"></i>&nbsp;&nbsp;Stock register book</a>
                            <!-- <a href="inventorapp/gin/gin.php" target="tar" class="nav-item nav-link btn text-left bor-ten text-white"  id="gin" name="gin"><i class="fas fa-truck-loading"></i>&nbsp;&nbsp;Goods Issue Note</a> -->
                            
                            
                        <!-- </div> -->
                        <!-- <div class="border bor-ten" style=" padding: 20px 30px 30px 20px; background-color:#F2F2F2; margin-top: 5%;"> -->
                            <h5>Others</h5>
                            <a href="salesapp/customer.php" target="tar" class="nav-item nav-link btn text-left bor-ten text-white"  id="supp" name="supp"><i class="fas fa-user-friends"></i>&nbsp;&nbsp;Customer</a>
        ...
        <div class="col py-4">
        <label for="dtandtm" class="border bor-ten" id="navg" name="navg" style="padding-left: 15px; padding-right: 15px; background-color: #FFFFFF;"><img src="images/logo.svg" style="width: 20px;">&nbsp;&nbsp;<a href="switcher.php" class="navigator">Austerity books</a> / <a href="#" class="navigator">Inventor</a></label>
            ...
            <iframe src="salesapp/dash.php" class="border-0" id="tar" name="tar" style="width: 100%; height: 89vh;  background-color: #FFFFFF;"></iframe>
        </div>
    </div>
</div>
<script>     
    ...
    $(document).ready(function(){
        ...
        $('#comp').click(function(){
            ...
            $('#navg').html("<img src=\"images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"switcher.php\" class=\"navigator\">Austerity books</a> / <a href=\"inventordash.php\" class=\"navigator\">Inventor</a> /  Inventory");
        })
        $('#users').click(function(){
            ...
            $('#supp').removeClass("btn-col");
            $("#navbarWEX").removeClass("show");
            $('#navg').html("<img src=\"images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"switcher.php\" class=\"navigator\">Austerity books</a> / <a href=\"inventordash.php\" class=\"navigator\">Inventor</a> /  Products");
        })
        $('#modul').click(function(){
            ...
            $('#supp').removeClass("btn-col");
            $("#navbarWEX").removeClass("show");
            $('#navg').html("<img src=\"images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"switcher.php\" class=\"navigator\">Austerity books</a> / <a href=\"inventordash.php\" class=\"navigator\">Inventor</a> /  Delivery Challan Entry");
        })
        $('#invoi').click(function(){
            ...
            $('#supp').removeClass("btn-col");
            $("#navbarWEX").removeClass("show");
            $('#navg').html("<img src=\"images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"switcher.php\" class=\"navigator\">Austerity books</a> / <a href=\"inventordash.php\" class=\"navigator\">Inventor</a> /  Invoice Entry");
        })
        $('#srb').click(function(){
            ...
            $('#supp').removeClass("btn-col");
            $("#navbarWEX").removeClass("show");
            $('#navg').html("<img src=\"images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"switcher.php\" class=\"navigator\">Austerity books</a> / <a href=\"inventordash.php\" class=\"navigator\">Inventor</a> /  Stock register book");
        })
        $('#gin').click(function(){
        ...
        $('#supp').click(function(){
            ...
            $('#gin').removeClass("btn-col");
            $("#navbarWEX").removeClass("show");
            $('#navg').html("<img src=\"images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"switcher.php\" class=\"navigator\">Austerity books</a> / <a href=\"inventordash.php\" class=\"navigator\">Inventor</a> /  Supplier");
        })
    })
</script>
</body>
