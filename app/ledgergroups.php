...
<div class="container-fluid">
    <div class="row">
                 ...
                 <div class="navbar-collapse collapse" id="navbarWEX">
                    <div class="nav flex-md-column flex-column" style="overflow: auto; padding-left: 20px; padding-right: 20px; padding-top: 20px; width: 100%;">
                        ...
                        <!-- <div class="border bor-ten" style=" padding-left: 30px; padding-right: 30px; padding-top: 20px; background-color:#F2F2F2; height: 60vh;"> -->
                            <h5>Ledger groups</h5>
                            <a href="pages/ledgergroups/view.php" target="tar" class="nav-item nav-link btn-primary active  btn text-left bor-ten"  id="users" name="users"><i class="far fa-eye"></i>&nbsp;&nbsp;View groups</a>
                            <a class="nav-item nav-link btn bor-ten text-left" id="comp" name="comp" href="pages/ledgergroups/add.php" target="tar"><i class="far fa-plus-square"></i>&nbsp;&nbsp;Add group</a>
                            <!-- <a href="pages/ledgergroups/view.php" target="tar" class="nav-item nav-link btn text-left bor-ten"  id="users" name="users"><i class="far fa-eye"></i>&nbsp;&nbsp;View groups</a> -->
                            <a href="#" class="nav-item nav-link btn text-left bor-ten" id="modul" name="modul"><i class="far fa-minus-square"></i>&nbsp;&nbsp;Delete group</a>
                            <!-- <h5>Vouchers</h5>
                        ...
                        <!-- <div class="border bor-ten" style=" padding: 20px 30px 30px 20px; background-color:#F2F2F2; margin-top: 5%;"> -->
                            ...
                            <!-- <a href="app/dash.php" target="tar" class="nav-item nav-link btn text-left bor-ten"  id="users" name="users"><i class="fas fa-cogs"></i>&nbsp;&nbsp;Settings & users</a> -->
                            <a href="../dash.php" class="nav-item nav-link btn text-left bor-ten"  ><i class="fas fa-chevron-circle-left"></i>&nbsp;&nbsp;Back to dash</a>
                        <!-- </div> -->
                    </div>
                </div>
            </nav>
        ...
        <div class="col py-2">
            <label for="dtandtm" class="border bor-ten" id="navg" name="navg" style="padding-left: 15px; padding-right: 15px; background-color: #F2F2F2;"><img src="../images/logo.svg" style="width: 20px;">&nbsp;&nbsp;<a href="../switcher.php" class="navigator">Tick</a> / <a href="../dash.php" class="navigator">Accounting</a> /  Ledger groups /  View groups</label>
            <!-- <ul class="breadcrumb">
            ...
            <iframe src="pages/ledgergroups/view.php" class="border bor-ten" id="tar" name="tar" style="width: 100%; height: 93vh;  background-color: #F2F2F2;"></iframe>
        </div>
    </div>
</div>
<script>     
    ...
    $(document).ready(function(){
        ...
        $('#comp').click(function(){
            ...
            $('#navg').html("<img src=\"../images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"../dash.php\" class=\"navigator\">Tick</a> / <a href=\"../dash.php\" class=\"navigator\">Accounting</a> / Ledger groups /  Add group");
        ...
        $('#users').click(function(){
            ...
            $('#modul').removeClass("btn-primary");
            $("#navbarWEX").removeClass("show");
            $('#navg').html("<img src=\"../images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"../dash.php\" class=\"navigator\">Tick</a> / <a href=\"../dash.php\" class=\"navigator\">Accounting</a> / Ledger groups /  View groups");
        })
        $('#modul').click(function(){
            ...
            $('#comp').removeClass("btn-primary");
            $("#navbarWEX").removeClass("show");
            $('#navg').html("<img src=\"../images/logo.svg\" style=\"width: 20px;\">&nbsp;&nbsp;<a href=\"../dash.php\" class=\"navigator\">Tick</a> / <a href=\"../dash.php\" class=\"navigator\">Accounting</a> / Ledger groups /  Delete group");
        })
    })
</script>
</body>
