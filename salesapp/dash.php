...
<body class="" style="height: 100vh;  background-color: #FFFFFF;">
        ...
        <div class="container-fluid" style="padding: 0% 5% 0% 5%;">
            <div class="row">
                <div class="col-lg-4" style="margin-top: 5%;">
                    <div class="bg-light p-5 border" style=" border-radius: 30px 30px 30px 30px;">
            ...
            <div class="row" >
                <div class="col-lg-4" style="margin-top: 5%;">
                    <div class="bg-wlight p-5 border" style="height: 300px;  border-radius: 30px 30px 30px 30px;">
                        <!-- <div class="card-header bg-primary text-white"><h4>Basic info</h4></div> -->
                        <!-- <div class="card-body" style="height: 300px;"> -->
                        <h4 class="text-primary"><img src="../images/support.svg" alt="info" style="width: 32px;">&nbsp;&nbsp;Basic info</h4><br />
                    ...
                    <!-- <div class="border-0 bg-light bor-ten" style="padding: 5% 5% 5% 5%; margin-bottom: 5%; height: 30vh;"> -->
                        
                                             
                    <!-- </div> -->
                </div>
                <div class="col-lg-4" style="margin-top: 5%;">
                    <div class="bg-light p-5 border" style="height: 300px;  border-radius: 30px 30px 30px 30px;">
                        <!-- <div class="card-header bg-primary text-white"><h4>Mailing Address</h4></div>
                        <div class="card-body" style="height: 200px;"> -->
                        <h4 class="text-primary"><img src="../images/bookcont.svg" alt="info" style="width: 32px;">&nbsp;&nbsp;Mailing address</h4><br />    
                ...
                <div class="col-lg-4" style="margin-top: 5%;">
                    <div class="bg-light p-5 border" style="height: 300px;  border-radius: 30px 30px 30px 30px;">
                        ...
                        <div class="card-body" style="height: 200px;"> -->
                        <h4 class="text-primary"><img src="../images/call.svg" alt="info" style="width: 32px;">&nbsp;&nbsp;Contact information</h4><br />     
                            <?php
                                echo 'Email : ' . $email . '<br />Phone number : ' . $phno . '<br />Web : <a href="' . $web . '" target="_blank">' . $web . '</a>';
                            ?>
                        <!-- </div> -->
                    </div>  
                </div>
