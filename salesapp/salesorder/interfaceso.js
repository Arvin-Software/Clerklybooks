$(document).ready(function(){
            ...
            //     // alert(myObj[0]);
            //     a += 1;
            //     $('#here_table').append('<tr><td><select id="prod' + a +'" name="prod' + a + '" class="custom-select prodx"></select></td><td><input class="form-control  rte " required="" type="text" name="hsn' + a + '" id="hsn' + a + '"></td><td><input class="form-control  rte accx" required="" type="text" name="dt' + a + '" id="dt' + a + '"></td><td><input class="form-control rte" required="" type="text" name="rt' + a + '" id="rt' + a + '"></td><td><input class="form-control rte " required="" type="text" name="cgstper' + a + '" id="cgstper' + a + '"></td><td><input class="form-control rte " required="" type="text" name="sgstper' + a + '" id="sgstper' + a + '"></td><td><input class="form-control rte" required="" type="text" name="amt' + a + '" id="amt' + a + '"></td><td><button type="button" id="deletebut" name="deletebut" class="btn btn-danger btndeleterowadded">X</button></td></tr>');
            //     for(i=1; i<=myObj[0]; i++){
