$(document).ready(function(){
    a = 0;
   //  alert('hello');
   $('#here_table').append('<tr><td><select id="it' + a +'" name="it' + a + '" class="custom-select prodx"></select></td><td><input class="form-control  rte " required="" type="text" name="dt' + a + '" id="dt' + a + '"></td><td><button type="button" id="deletebut" name="deletebut" class="btn btn-danger btndeleterowadded">X</button></td></tr>');
   // a += 1;
